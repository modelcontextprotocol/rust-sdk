...
async fn test_elicitation_request_param_serialization() {
    ...
    let request_param = CreateElicitationRequestParam::FormElicitationParam {
    ...
    match (&deserialized, &request_param) {
        (
            CreateElicitationRequestParam::FormElicitationParam {
                message: msg1,
...
async fn test_elicitation_json_rpc_protocol() {
    ...
    let request = JsonRpcRequest {
        ...
        request: CreateElicitationRequest {
            ...
            params: CreateElicitationRequestParam::FormElicitationParam {
...
async fn test_elicitation_error_handling() {
    ...
    let minimal_schema_request = CreateElicitationRequestParam::FormElicitationParam {
    ...
    // Test empty message
    let empty_message_request = CreateElicitationRequestParam::FormElicitationParam {
        message: "".to_string(),
...
async fn test_elicitation_performance() {
    ...
    let request = CreateElicitationRequestParam::FormElicitationParam {
...
async fn test_elicitation_convenience_methods() {
    ...
    let confirmation_request = CreateElicitationRequestParam::FormElicitationParam {
...
async fn test_elicitation_direction_server_to_client() {
    ...
    let elicitation_request = CreateElicitationRequestParam::FormElicitationParam {
...
async fn test_create_elicitation_with_timeout_basic() {
    ...
    let _params = CreateElicitationRequestParam::FormElicitationParam {
...
async fn test_url_elicitation_request_param_serialization() {
    let request_param = CreateElicitationRequestParam::UrlElicitationParam {
    ...
    let deserialized: CreateElicitationRequestParam = serde_json::from_value(expected).unwrap();
    match deserialized {
        CreateElicitationRequestParam::UrlElicitationParam {
            message,
            url,
            elicitation_id,
        } => {
...
async fn test_url_elicitation_json_rpc_protocol() {
    ...
    let request = JsonRpcRequest {
        ...
        request: CreateElicitationRequest {
            method: ElicitationCreateRequestMethod,
            params: CreateElicitationRequestParam::UrlElicitationParam {
...
async fn test_elicitation_both_modes() {
    ...
    let form_request = CreateElicitationRequestParam::FormElicitationParam {
    ...
    // URL mode
    let url_request = CreateElicitationRequestParam::UrlElicitationParam {
