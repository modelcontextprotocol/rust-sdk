...
async fn test_sse_server_basic_common(bind_addr: std::net::SocketAddr, ct: CancellationToken, service_ct: CancellationToken) -> anyhow::Result<()> {
...
async fn test_client_server_integration_common(actual_addr: std::net::SocketAddr, ct: CancellationToken) -> anyhow::Result<()> {
...
#[cfg(all(feature = "transport-sse-server", feature = "transport-sse-client", feature = "actix-web"))]
#[actix_web::test]
...
#[cfg(feature = "transport-sse-client")]
async fn test_concurrent_clients_common(actual_addr: std::net::SocketAddr, ct: CancellationToken) -> anyhow::Result<()> {
    use rmcp::transport::SseClientTransport;
